<?php 
	...
	{
		$list = CHtml::activeDropDownList($model,'deal_id',CHtml::listData(Deal::model()->findAll(array('condition'=>'status="1" and active_status="S" and deal_id in ('.$deal_ids_string.')','order'=>'title')), 'deal_id', 'title'),array('prompt'=>'-- Deal --'));
	}else{
		$list = false;
	}
?>
				...
				'columns'=>array(
						...
						array(
							...
							(
								'activate' => array
								(
									'url'=>'Yii::app()->createUrl("owner/dealComment/setstatus",array("id"=>$data->comment_id,"active_status"=>"S"))',
									 'options'=>array(
											'id'=>'$data->comment_id',
								...
								'deactivate' => array
								(
									'url'=>'Yii::app()->createUrl("owner/dealComment/setstatus",array("id"=>$data->comment_id,"active_status"=>"H"))',
									 'options'=>array(
											'id'=>'$data->comment_id',
