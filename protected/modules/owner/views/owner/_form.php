...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<p class="note note-danger">Fields with <span class="required">*</span> are required.</p>
		<div class="form-group row">
			<?php echo $form->labelEx($model,'owner_role_id',array('class'=>'col-lg-2 control-label')); ?>
			<div class="col-lg-10">
				<?php echo $form->dropDownList($model,'owner_role_id',$owner_role,  array('empty'=>'-- Select --','class'=>'form-control input-large') );?>
	...
	<?php if(Yii::app()->controller->action->id == 'create'){ ?>
			...
			<div class="col-lg-10">
				<div class="fileinput <?php echo $cur_state?>" data-provides="fileinput">
					...
					<div>
						...
						<a href="#" id = "remove_file" class="btn blue fileinput-exists" data-dismiss="fileinput">
							Remove 
						</a>					
					</div>
		...
		<div class="form-group row buttons">
			<div class="col-lg-offset-2 col-md-9">
				...
				<button class="btn btn-danger"  type="button" onclick="javascript:window.location.href='<?php echo Yii::app()->baseUrl?>/owner/owner/admin'">Cancel</button>
			</div>
		</div>
	<?php $this->endWidget(); ?>
