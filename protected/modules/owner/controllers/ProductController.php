...
class ProductController extends Controller
{
	...
	{
		// find product only from shops which owner has created.
		...
		$model=Product::model()->findByPk($id,$condition);
		if($model===null){
	...
	public function actionUploadData()
	{
		...
		if(!empty($data))
		{
			...
			$del_path = "/shopnext/owner/product/upload/_method/delete/file/";
