...
class Owner extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'parentId' => array(self::BELONGS_TO, 'Owner', 'parent_id'),
	...
	public function search()
	{
		...
		if(empty($created_by)){
			$criteria->AddCondition('owner_id!='.$owner_id.' and parent_id='.$owner_id );
		}else{
			$criteria->AddCondition('owner_id!='.$owner_id.' and created_by='.$owner_id );
		}	
