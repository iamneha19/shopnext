<div class="form">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="form-group row">
			...
			<div class="col-md-4">
				<?php echo (!empty($model->product->shop->name))? CHtml::link($model->product->shop->name,array('shop/view','id'=>$model->product->shop->shop_id), array('target'=>'_blank')) :'';?>
		...
		<div class="form-group row">
			<div class="col-lg-offset-2 col-md-9">
				...
				<button class="btn btn-danger"  type="button" onclick="javascript:window.location.href='<?php echo Yii::app()->baseUrl?>/superadmin/productComment/admin'">Cancel</button>
			</div>
		</div>
