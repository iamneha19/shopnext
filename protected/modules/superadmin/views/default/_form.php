<div class="form">
	<?php 
		...
		<div class="form-group row buttons">
				...
				<?php $role_type = ApplicationSessions::run()->read('role_permission'); 
				if(!empty($role_type['ADMIN'][4])){ ?>
				...
				<?php }else{ ?>
						<button class="btn btn-danger"  type="button" onclick="javascript:window.location.href='<?php echo Yii::app()->baseUrl?>/superadmin/default/view'">Cancel</button>
				<?php } ?>
			</div>
		</div>
	<?php $this->endWidget(); ?>
