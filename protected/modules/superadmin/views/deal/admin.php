	...
	<div class="panel panel-default gradient">
		...
		<div class="panel-body noPad clearfix">
            <span class = "pull-leftt">
				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li>
							<a href="#"  onclick="changeStatus('ManageHot','Yes');return false;">
							Mark hot deal</a>
						</li>
						<li>
							<a href="#"  onclick="changeStatus('ManageHot','No');return false;">
							Unmark hot deal</a>
						</li>
						<?php }	?>
			...
			<span class = "pull-right">
				<span class="badge list-group-item-warning" >
					&nbsp;<i class="fa fa-star"></i>&nbsp;<strong>Hot deals</strong>&nbsp;
				</span>
			...
			<?php $this->widget('bootstrap.widgets.TbGridView', array(
				...
				'rowCssClassExpression' => '
					...
					( ($data->is_hot_deal=="Yes") ? " warning" : null )
				',
				...
				'columns'=>array(
								...
								array(
										...
										'filter' =>CHtml::activeDropDownList($model,'shop_id',CHtml::listData(Shop::model()->findAll(array('condition'=>'status="1"','order'=>'name')), 'shop_id', 'name'),array('prompt'=>'-- Shop --')),
								),
								'title',
								 array(
										'name' => 'start_date',                             
								...
								array(
										'name'=>'is_hot_deal',
										'value'=>'$data->is_hot_deal',
										'filter' => CHtml::dropDownList(
														'Deal[is_hot_deal]',
														$model->is_hot_deal,
														array("No"=>"No","Yes" => "Yes"),array('empty' => '-- All --')),
									),
								array(
										'class'=>'CButtonColumn',
										...
										'buttons'=>array(
													'update' => array
													(
														'url'=>'Yii::app()->createUrl("superadmin/deal/update",array("id"=>$data->deal_id))',
														'label' =>'Update',
													...
													'activate' => array
													(
														'url'=>'Yii::app()->createUrl("superadmin/deal/setstatus",array("id"=>$data->deal_id,"active_status"=>"S"))',
															 'options'=>array(
															...
															'deactivate' => array
													(
														'url'=>'Yii::app()->createUrl("superadmin/deal/setstatus",array("id"=>$data->deal_id,"active_status"=>"H"))',
															 'options'=>array(
																	'id'=>'$data->active_status',
