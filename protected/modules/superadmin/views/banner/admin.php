<?php
	...
	$this->menu=array(
			array('label' => 'Add Banner', 'url' => 'create','htmlOptions' => array('class'=>'btn-default btn-sm'),'icon' => 'plus'),
		);
?>
			...
			<?php $this->widget('bootstrap.widgets.TbGridView', array(
				...
				'columns'=>array(
						array(
							...
							'selectableRows'=>2,
							'checkBoxHtmlOptions'=>array('name'=>'banner_id_arr[]'),
						),
						array(
							'header'=>'Sr. No.',
						 ...
						 array(
							'header' => 'banner',
							'type' => 'raw',
							'value' =>'CHtml::image(($data->banner && $data->type == "I") ? Yii::app()->baseUrl."/upload/banner/".$data->banner : "http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=code+image","",array("width">50, "height"=>50))', 
						),
												
						array(
							'name'=>'type',
							'value'=>'($data->type == "I") ? "Image" :"Code"',
							'filter' => CHtml::dropDownList(
												'Banner[type]',
												$model->type,
												array("I" => "Image","C"=>"Code"),array('empty' => '-- All --')),
						),
						'location',
						array(
							'name'=>'active_status',
						...
						array(
							...
							(
								 'activate' => array
								(
									'url'=>'Yii::app()->createUrl("superadmin/banner/setstatus",array("id"=>$data->banner_id,"active_status"=>"S"))',
										 'options'=>array(
												'id'=>'$data->active_status',
																'onClick'=>'return confirm("Are you sure to activate this banner?")'
											),
								...
								'deactivate' => array
								(
									'url'=>'Yii::app()->createUrl("superadmin/banner/setstatus",array("id"=>$data->banner_id,"active_status"=>"H"))',
										 'options'=>array(
												'id'=>'$data->active_status',
												'onClick'=>'return confirm("Are you sure to deactivate this banner?")'
											),
...
<script>
	...
	{
		var check = $("input[name='banner_id_arr[]']:checked");
		...
		if(check.length>0)
		{
			...
			bootbox.alert("No banners selected !!!");    
		}
	}
</script>
