				...
				'columns'=>array(
					...
					array(
						    ...
						    (
								'manage_images' => array
								(
									'url'=>'Yii::app()->createUrl("superadmin/product/manageImages", array("id"=>$data->product_id))',
										'options'=>array(
											'id'=>'$data->shop_id',
										),
						        ...
						        'activate' => array
						        (
						            'url'=>'Yii::app()->createUrl("superadmin/product/setstatus",array("id"=>$data->product_id,"active_status"=>"S"))',
						        	 'options'=>array(
							                'id'=>'$data->product_id',
								...
								'deactivate' => array
						        (
						            'url'=>'Yii::app()->createUrl("superadmin/product/setstatus",array("id"=>$data->product_id,"active_status"=>"H"))',
						        	 'options'=>array(
							                'id'=>'$data->product_id',
