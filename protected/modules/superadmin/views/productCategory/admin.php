...
/* @var $model ProductCategory */
	...
	if(in_array('Create',$user_rights)){
		$this->menu=array(
			array('label' => 'Add Product Category', 'url' => 'create','htmlOptions' => array('class'=>'btn-default btn-sm'),'icon' => 'plus'),
		);
	}
	$template = "";
			...
			<?php $this->widget('bootstrap.widgets.TbGridView', array(
				...
				'columns'=>array(
							array(
								...
								'selectableRows'=>2,
								'checkBoxHtmlOptions'=>array('name'=>'product_category_id_arr[]'),
							),
							array(
									'header'=>'Sr. No.',
							...
							array(
									...
									'filter' => CHtml::dropDownList('ProductCategory[active_status]',
									$model->active_status,
							...
							array(
								...
								'buttons'=>array(   
										'activate' => array
										(
											'url'=>'Yii::app()->createUrl("superadmin/productCategory/setstatus",array("id"=>$data->product_category_id,"active_status"=>"S"))',
												 'options'=>array(
														'id'=>'$data->active_status',
																		'onClick'=>'return confirm("Are you sure to activate this product category?")'
													),
										...
										'deactivate' => array
										(
											'url'=>'Yii::app()->createUrl("superadmin/productCategory/setstatus",array("id"=>$data->product_category_id,"active_status"=>"H"))',
												 'options'=>array(
														'id'=>'$data->active_status',
														'onClick'=>'return confirm("Are you sure to deactivate this product category?")'
													),
...
<script>
	...
	{
		var check = $("input[name='product_category_id_arr[]']:checked");
		...
		if(check.length>0)
		{
			...
			bootbox.alert("No products categories selected !!!");    
		}
	}
</script>
