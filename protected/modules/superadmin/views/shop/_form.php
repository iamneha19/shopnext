<div class="form">
	...
	?>
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'owner_id',array('class'=>'col-md-2 control-label')); ?>
			<div class="col-md-6">
				<?php $this->widget('ext.MyAutoComplete', array(
					'model'=>$model,
					'attribute'=>'owner_id',
					'htmlOptions'=>array('Placeholder'=>'Type to get list of owners....','class'=>'form-control input-large'),
					'value'=>(!empty($model->owner_id))?$model->owner->name:'',
					'source'=>$this->createUrl('shop/AutocompleteOwner'),
					'options'=>array(
							'showAnim'=>'fold',
							'minLength'=>'1',
					),
		...
		<div class="form-group row">
			...
			<div class="col-md-6">
				<?php echo $form->textarea($model,'description',array('class'=>'form-control input-large','size'=>60)); ?>
		...
		<div class="form-group row">
			<?php echo $form->labelEx($model,'home_delivery',array('class'=>'col-md-2 control-label')); ?>
			<div class="col-md-6">
				
				<?php echo $form->dropDownList($model,'home_delivery', array('Y'=>'Yes','N'=>'No'), array('class'=>'form-control input-small')); ?>
				<?php echo $form->error($model,'home_delivery'); ?>
			</div>
		</div>	
		<div class="form-group row">
		...
		<div class="form-group row">
			<div class="col-md-offset-2 col-md-9">
				...
				<button class="btn btn-danger"  type="button" onclick="javascript:window.location.href='<?php echo Yii::app()->baseUrl?>/superadmin/shop/admin'">Cancel</button>
			</div>
		</div>	
	<?php $this->endWidget(); ?>
</div>
...
<script type='text/javascript'>	
	$(document).ready(function()
	{
		...
		$('#Shop_owner_id_autocomplete').val('<?php echo $model->owner_id; ?>');
