			...
			<?php $this->widget('bootstrap.widgets.TbGridView', array(
				...
				'columns'=>array(
						...
						array(
							...
							'filter' =>CHtml::activeDropDownList($model,'owner_id',CHtml::listData(Owner::model()->findAll(array('condition'=>'status="1" and active_status="S" and created_by is null','order'=>'name')), 'owner_id', 'name'),array('prompt'=>'-- Owner name --')),
						),
						array(
							'name'=>'active_status',
						...
						array(
							...
							(
								'manage_images' => array
								(
									'url'=>'Yii::app()->createUrl("superadmin/shop/manageImages", array("id"=>$data->shop_id))',
										'options'=>array(
											'id'=>'$data->shop_id',
										),
								 ...
								 'activate' => array
								(
									'url'=>'Yii::app()->createUrl("superadmin/shop/setstatus",array("id"=>$data->shop_id,"active_status"=>"S"))',
										 'options'=>array(
								...
								'deactivate' => array
								(
									'url'=>'Yii::app()->createUrl("superadmin/shop/setstatus",array("id"=>$data->shop_id,"active_status"=>"H"))',
										 'options'=>array(
												'id'=>'$data->active_status',
