<?php
	...
	if(in_array('View',$user_rights)){ 
		array_push($this->menu, array('label'=>'View Country', 'url'=>array('view', 'id'=>$model->locality_id),'htmlOptions' => array('class'=>'btn-default btn-sm'),'icon' => 'magnifier'));	
	}
...
<div class="col-lg-12">
	<div class="panel panel-default hover">
		...
		<div class="panel-body">
			...
			<?php echo $this->renderPartial('_form', array('model'=>$model,'cities'=>$cities,'countries'=>$countries,'states'=>$states)); ?>
		</div>
	</div>
</div>