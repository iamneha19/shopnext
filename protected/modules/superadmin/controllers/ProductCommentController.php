...
class ProductCommentController extends Controller
{
	...
	public function loadModel($id)
	{
		...
		if($model===null){				
			...
			throw new CHttpException(404,'The requested product comment record has been deleted !!!');			
		}	
		return $model;
	}
	...
	*/
	public function actionchangeStatus()
	{
		...
		if(isset($_POST))
		{
			...
			$product_id_arr = explode(",",$_POST['product_ids']); // To update total_comments of product
		...
		// code to update total_comments of product.
