...
class ShopCommentController extends Controller
{
	...
	public function loadModel($id)
	{
		...
		if($model===null){
			...
			throw new CHttpException(404,'The requested shop comment record has been deleted !!!');			
		}	
		return $model;
	}
	...
	*/
	public function actionchangeStatus()
	{
		...
		if(isset($_POST))
		{
			...
			$shop_id_arr = explode(",",$_POST['shop_ids']); // To update total_comments of shop
		...
		// code to update total_comments of shop.
