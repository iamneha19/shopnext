...
class BrandController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes = array_map('trim',$_POST['Brand']);
			$model->added_on   = time();
	...
	public function actionDelete($id)
	{
		try
		{
			Controller::updateDeletedStatus('Brand',$id);
		}
	...
	public function loadModel($id)
	{
		...
		if($model===null){
			...
			throw new CHttpException(404,'The requested brand record has been deleted !!!');			
		}	
		return $model;
	}
