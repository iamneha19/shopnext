 ...
 */
class OwnerLogin extends CFormModel
{
	public $username;
	public $password;
	public $rememberMe;
	...
	public function rules()
	{
		return array(
			...
			array('username', 'email','message'=>'Username is invalid.'),
		...
		if(!$this->hasErrors())
		{
			...
			switch($identity->errorCode)
			{
				case UserIdentity::ERROR_STATUS_DELETED:
					...
					$this->addError("password","Your account is deactivated.");
					break;
	...
	public function login()
	{
		if($this->_identity===null)
		{
			...
			$this->_identity->ownerAuthenticate();
		}		
