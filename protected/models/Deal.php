...
class Deal extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            array('shop_id, title, desc, start_date, end_date, amount, type,active_status,is_hot_deal', 'required'),
            array('amount, total_comments', 'numerical', 'integerOnly'=>true),
			...
			array('deal_id, shop_id, title, desc, code, start_date, end_date,deal_image, amount, type, active_status,is_hot_deal, added_on, updated_on, status', 'safe', 'on'=>'search'),
		);
	}
